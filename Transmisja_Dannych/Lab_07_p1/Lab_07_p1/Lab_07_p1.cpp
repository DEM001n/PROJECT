...
int main() {
    ...
    saveBandwidthsToFile("ASK", freq, ampAsk, "bandwidths.txt");
    saveBandwidthsToFile("FSK", freq, ampFsk, "bandwidths.txt");
    saveBandwidthsToFile("PSK", freq, ampPsk, "bandwidths.txt");
